...
import { OwnerForm, OwnerFormComponent, ProfileForm } from '../../components/owner-form/owner-form.component';
...
import { phoneMobileE164Validator } from '../../../../shared/validators/phone.validator';
...
@Component({
  ...
  standalone: true,
  imports: [ReactiveFormsModule, OwnerFormComponent],
